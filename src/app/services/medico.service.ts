...
export class MedicoService {
  ...
  insertMedico(medico: MedicoModule) {
    try {
      ...
      this.toastr.success('Operación realizada con exito', 'Medico Agregado con exito');
    }
    catch (err) {
  ...
  updateMedico(medico: MedicoModule) {
    try {
      ...
      this.toastr.success('Operación realizada con exito', 'Medico Actualizado con exito');
    }
    catch (err) {
  ...
  deleteMedico(key: string) {
    try {
      ...
      this.toastr.success('Operación realizada con exito', 'Medico Eliminado con exito');
    }
    catch (err) {
